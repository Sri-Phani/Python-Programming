...
##a.geometry('300x200')
##def example():
##    messagebox.askquestion('hi',"i love you")#showerror,showwarning,askyesno,askokcancel
##
##b=tk.Button(a,text="submit",fg='black',bg='pink',command=example)
##b.pack()
##a.mainloop()
...
year=Spinbox(r,from_=2000,to=3000,width="8")
